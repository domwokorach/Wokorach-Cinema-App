...
export default function SignUpPage() {
        ...
        <Card className="w-full max-w-md border-zinc-800 bg-zinc-900/80 backdrop-blur-sm">
          <CardHeader className="space-y-2 text-center">
            ...
            <CardDescription className="text-zinc-400">
              We sent a confirmation link to <span className="font-medium text-zinc-300">{email}</span>.
              Click the link to activate your account and start discovering movies.
            </CardDescription>
          </CardHeader>
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-b from-zinc-950 via-zinc-900 to-zinc-950 px-4">
      <Card className="w-full max-w-md border-zinc-800 bg-zinc-900/80 backdrop-blur-sm">
        <CardHeader className="space-y-2 text-center">
          <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-violet-600/20">
          ...
          <CardDescription className="text-zinc-400">
            Join CineMatch and get AI-powered movie recommendations
          </CardDescription>
        </CardHeader>
          ...
          <form onSubmit={handleEmailSignUp} className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                required
                className="border-zinc-700 bg-zinc-800/50 text-zinc-100 placeholder:text-zinc-500 focus-visible:ring-violet-500"
              />
            </div>
        ...
        <CardFooter className="justify-center">
          <p className="text-sm text-zinc-500">
            ...
            <Link href="/login" className="text-violet-400 hover:text-violet-300 underline-offset-4 hover:underline">
              Sign in
            </Link>
          </p>
        </CardFooter>
